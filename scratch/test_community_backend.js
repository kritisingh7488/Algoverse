...
async function runTests() {
    ...
    const userAData = {
        ...
        email: `usera_${timestamp}@algoverse.test`,
    ...
    const userBData = {
        ...
        email: `userb_${timestamp}@algoverse.test`,
        password: 'Password123!',
        role: 'user'
    };
    const adminData = {
        ...
        email: `admin_${timestamp}@algoverse.test`,
        password: 'Password123!',
        role: 'admin'
    };
    ...
    try {
        ...
        // Delete test community will occur at the end of CRUD
    } catch (err) {
