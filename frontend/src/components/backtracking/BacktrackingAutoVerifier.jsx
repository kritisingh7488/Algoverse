...
const ALGORITHMS = [
  'nqueens', 'sudoku', 'subset_sum', 'permutations'
];

export default function BacktrackingAutoVerifier({ onClose }) {
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-foreground">
                Automated C++ Backtracking Engine Verification
              </h3>
              <p className="text-xs text-muted">
                Executes automated tests for N-Queens, Sudoku, etc.
              </p>
            </div>
          </div>
          ...
          {results.map((res, i) => (
            <Card key={i} className={`p-3 border-l-4 rounded-lg flex items-center justify-between ${
              ...
              <div className="flex items-center gap-3 w-1/3">
                ...
                <div className="text-xs font-bold font-mono text-foreground">{res.algo.toUpperCase()}</div>
              </div>
