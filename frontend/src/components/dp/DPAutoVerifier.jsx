...
const ALGORITHMS = [
  'fibonacci', 'climbing', 'knapsack'
];

export default function DPAutoVerifier({ onClose }) {
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-foreground">
                Automated C++ Dynamic Programming Verification
              </h3>
              <p className="text-xs text-muted">
                Executes automated tests for DP algorithms.
              </p>
            </div>
          </div>
