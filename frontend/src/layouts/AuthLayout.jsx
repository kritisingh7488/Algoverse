...
const AuthLayout = ({ children, title, subtitle }) => {
  return (
    <div className="min-h-screen flex bg-background font-body text-textPrimary selection:bg-primary/20 selection:text-primary">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative bg-cardAccent border-r-[1.5px] border-borderTheme overflow-hidden flex-col justify-center items-center p-12 text-center">
      ...
      <div className="w-full lg:w-[55%] flex items-center justify-center p-6 sm:p-12 lg:p-20">
        ...
        >
          <div className="bg-card rounded-card shadow-medium border-[1.5px] border-borderTheme p-6 sm:p-8">
